...
fileController.setStatus = (req, res, next) => {
  console.log('req:', req.body);
  const queryString = `update users set userstatus = '${req.body.status}' where username='${req.body.username}'`;
  db.query(queryString).then(console.log('status saved in database'));
  //console.log('res:', res);
  return next();
};
